...
export class Backend implements backendInterface {
    ...
    async clearAllSubmissions(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteContactSubmission(arg0: Principal, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async deleteServiceInquiry(arg0: Principal, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteServiceInquiry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllContactSubmissions(): Promise<Array<[Principal, Array<ContactSubmission>]>> {
        if (this.processError) {
            try {
    ...
    async getAllServiceInquiries(): Promise<Array<[Principal, Array<Inquiry>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllServiceInquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactSubmissions(arg0: Principal): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
    ...
    async getPaymentTerms(): Promise<PaymentTerms> {
        if (this.processError) {
            try {
                const result = await this.actor.getPaymentTerms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceInquiries(arg0: Principal): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServiceInquiries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceInquiriesCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getServiceInquiriesCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWorkProcessSteps(): Promise<Array<WorkProcessStep>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWorkProcessSteps();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveContactSubmission(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveContactSubmission(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveServiceInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveServiceInquiry(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async testMessage(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.testMessage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
